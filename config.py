...
DE_UNIVERSE = [
    ...
    "BEI.DE", "MTX.DE", "RHM.DE", "CBK.DE", "SRT3.DE",
    ...
    "AT1.DE", "BOSS.DE", "DUE.DE", "FNTN.DE", "GXI.DE",
    "JUN3.DE", "KRN.DE", "LXS.DE", "NEM.DE", "RAA.DE", "TLX.DE",
    "WAF.DE", "AIXA.DE", "COK.DE", "EVT.DE", "KCO.DE",
    "PSM.DE", "SAX.DE", "TMV.DE", "BC8.DE", "UTDI.DE",
    "G24.DE", "DHER.DE", "NDX1.DE", "RDC.DE", "TKA.DE", "FPE3.DE",
    "KBX.DE", "HAG.DE", "GBF.DE", "DWNI.DE", "8TRA.DE", "1U1.DE",
    "HOT.DE", "R3NK.DE", "S92.DE", "DRW3.DE", "GFT.DE",
