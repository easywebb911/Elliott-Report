...
nach PR #70 (**Zonen-Abstand in Prozent**, gemerged `bef1d7f`); dieser PR:
**Kurs-Stand-Wächter** (Health-Regel „Kurse veraltet" + Hinweis im
Lauf-Status), offen. Das **EXZELLENZ-AUDIT P1–P4** ist mit #47 komplett.
Alle Zahlen/Hashes sind gegen `git log` und den Code geprüft, nicht aus dem
Gedächtnis.

> **BRANCH-BASIS:** frisch von `main` (`bef1d7f` = #70-Merge) abgezweigt.

> **FAHRPLAN (Easy, 04.08.2026) — in dieser Reihenfolge, nicht auf Zuruf:**
> 1. **Kurs-Stand-Wächter** (dieser PR) → Easys Merge.
> 2. **Sammlungs-Schutz, Variante C** — markt-bewusste Anker (`last_fresh_run_date`
