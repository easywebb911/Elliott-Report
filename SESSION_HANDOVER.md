...
nach PR #69 (**notify-Skriptstart + Score-Dezimale**, gemerged `7327ee0`);
dieser PR: **Zonen-Abstand in Prozent** an Zielzone und Extension (reines
Frontend), offen. Das **EXZELLENZ-AUDIT P1–P4** ist mit #47 komplett.
Alle Zahlen/Hashes sind gegen `git log` und den Code geprüft, nicht aus dem
Gedächtnis.

> **BRANCH-BASIS:** frisch von `main` (`ed4770c` = Datenstand nach dem #69-Merge) abgezweigt.
