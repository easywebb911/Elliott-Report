...
nach PR #55 (**Validierungs-Seite in Klartext**, gemerged); dieser PR: **Methodik — doppelte Konfluenz-Erklärung entfernt**, offen. Das **EXZELLENZ-AUDIT P1–P4** ist mit #47 komplett.
Alle Zahlen/Hashes sind gegen `git log` und den Code geprüft, nicht aus dem
Gedächtnis.

> **BRANCH-BASIS:** frisch von `main` (`9613fc0` = #55-Merge) abgezweigt.
