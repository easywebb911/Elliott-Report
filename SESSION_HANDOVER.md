...
nach PR #58 (**Auswertungs-Programm v1**, gemerged); dieser PR: **Code-Hygiene — eine Zähl-Quelle**, offen. Das **EXZELLENZ-AUDIT P1–P4** ist mit #47 komplett.
Alle Zahlen/Hashes sind gegen `git log` und den Code geprüft, nicht aus dem
Gedächtnis.

> **BRANCH-BASIS:** frisch von `main` (`f006abb` = täglicher Commit nach
> dem #58-Merge) abgezweigt.
