...
**Watchlist-Sync repariert** (sha ohne Zwischenspeicher, Warteschlange,
persistierter Fehlerzustand, Backoff), offen. Das **EXZELLENZ-AUDIT P1–P4**
ist mit #47 komplett.
Alle Zahlen/Hashes sind gegen `git log` und den Code geprüft, nicht aus dem
Gedächtnis.

> **BRANCH-BASIS:** von `main` (`6731f96`) abgezweigt, nach dem #72-Merge auf
> `3a8ae52` rebasiert — nicht auf den Sammlungs-Schutz-Zweig gestapelt.
