...
nach PR #54 (**Heartbeat-Push**, gemerged; erster echter Puls live am 28.07. 16:07 UTC); dieser PR: **Validierungs-Seite in Klartext**, offen. Das **EXZELLENZ-AUDIT P1–P4** ist mit #47 komplett.
Alle Zahlen/Hashes sind gegen `git log` und den Code geprüft, nicht aus dem
Gedächtnis.

> **BRANCH-BASIS:** frisch von `main` (`4130724` = täglicher Commit nach dem
> #54-Merge) abgezweigt.
