...
nach PR #59 (**Code-Hygiene / eine Zähl-Quelle**, gemerged); dieser PR: **Abruf-Robustheit + Ehrlichkeit der Ausgabe** (Folge des Trockenlaufs), offen. Das **EXZELLENZ-AUDIT P1–P4** ist mit #47 komplett.
Alle Zahlen/Hashes sind gegen `git log` und den Code geprüft, nicht aus dem
Gedächtnis.

> **BRANCH-BASIS:** frisch von `main` (`58502d2` = #59-Merge) abgezweigt.
