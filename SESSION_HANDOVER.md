...
allein mit diesem Dokument (plus Repo) weiterarbeiten können. Stand: **30.07.2026**,
nach PR #62 (**Journal ein Commit, Kurs-Abruf dispatchbar, Bar-Diagnose mit Datum**,
gemerged); dieser PR: **Abruf prüft Endlichkeit, `last_bar_date` im Report, Registry-Notiz zum Ein-Tag-Versatz**, offen. Das **EXZELLENZ-AUDIT P1–P4** ist mit #47 komplett.
...
- **OFFEN (nach diesem PR zu holen) — Kurs-Abruf mit Löchern:** der dispatchbare `eval_prices.yml` muss einmal laufen und zeigen, ob Ticker mit nicht-endlichen Schlusskursen jetzt **namentlich** in `ticker_mit_luecken` auftauchen und der Lauf dadurch **rot** wird. Am 29.07. lieferte der Dispatch 33/33 Ticker ohne Lücken (US 501 Bars, DE 507 Bars, alle bis 2026-07-29) — der Löcher-Fall ist also noch **nicht** live gesehen, nur offline nachgestellt.
