...
nach PR #68 (**Episoden-Anschluss zählt Kalendertage**, gemerged `6b6e27d`);
dieser PR: **notify-Skriptstart + Score-Dezimale im Alarm-Push** (zwei Pushes,
die nicht feuern konnten), offen. Das **EXZELLENZ-AUDIT P1–P4** ist mit #47 komplett.
Alle Zahlen/Hashes sind gegen `git log` und den Code geprüft, nicht aus dem
Gedächtnis.

> **BRANCH-BASIS:** frisch von `main` (`6b6e27d` = #68-Merge) abgezweigt.
